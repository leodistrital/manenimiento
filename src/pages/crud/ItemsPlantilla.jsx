...
export const ItemsPlantilla = ({ llave }) => {
	let emptyProduct = {
		id: null,
		nombre: "",
	};
	const TABLA = "plantillaitem/" + llave;
	const titulo = "Materiales Subpartida";
	...
	useEffect(() => {
		...
		datatable.gettable("item").then((lista) => settableDropdown1(lista));
	}, []);
	...
	const saveProductPlantilla = () => {
		...
		resultado = datatable.getCrearItem("plantillaitem", datosEnvio);
