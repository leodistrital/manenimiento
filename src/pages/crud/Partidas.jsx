...
import { DetalleSubpartidas } from './DetalleSubpartidas';
...
export const Partidas = () => {
	...
	const TABLA = "partida";
	const titulo = "Partidas";

	const [productDialog, setProductDialog] = useState(false);
	const [deleteProductDialog, setDeleteProductDialog] = useState(false);
	const [product, setProduct] = useState(emptyProduct);
	const [submitted, setSubmitted] = useState(false);
	const [dropdownCapitulos, setdropdownCapitulos] = useState(null);
	...
	useEffect(() => {
		...
		datatable.gettable("parametros/capitulos").then((capitulos) => {
			setdropdownCapitulos(capitulos);
		});
	}, [productDialog]);
			...
			<div className="col-12">
				<div className="card">
					...
					>
						...
						<div className="formgrid grid">
							<div className="field col">
								<label htmlFor="quantity">Capítulo</label>
								<Dropdown
									value={product.cod_cap_par}
									onChange={(e) => {
										setProduct({ ...product, cod_cap_par: e.value });
									}}
									options={dropdownCapitulos}
									optionLabel="name"
							...
							<div className="field col">
								...
								<InputNumber
									...
									onValueChange={(e) => onInputNumberChange(e, "factor")}
								/>
							</div>
						</div>
						{
                            product?.id >0 &&  <DetalleSubpartidas  llave={product?.id} />
                        }
