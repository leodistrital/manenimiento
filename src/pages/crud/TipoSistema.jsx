							...
							<TabPanel
								...
								<div className='formgrid grid'>
									<div className='field col'>
										...
										<label htmlFor='nom_tsi'>Nombre:</label>
										<InputText
											id='nom_tsi'
											value={formData.nom_tsi}
											onChange={(e) =>
												onInputChange(e, "nom_tsi")
											}
											required
											autoFocus
